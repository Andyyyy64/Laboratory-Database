        ...
        <>
            <div className=' bg-white w-screen h-screen'>
                ...
                <div className='text-center'>
                    ...
                    <h2 className='text-black text-lg font-bold'>or</h2>
                    <a href='https://twitter.com/Fukmylife44' className='text-lg'>DM me on twitter</a><br />
                    ...
                    <h2 className='text-black text-3xl mt-24'>Thank you so much for visiting our site!! <br />
                        Should you have any inquiries or require assistance, <br />
